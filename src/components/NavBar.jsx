  ...
  return (
    <div className="flex justify-between items-center w-full text-white
     px-4 bg-black fixed pt-3">
      ...
      {nav && (
      <ul className="flex flex-col justify-center absolute top-0 left-0
      w-full h-screen bg-gradient-to-b from-black 
      to-gray-500 items-center text-gray-500">
            {links.map(({link,i}) => (
                <li 
